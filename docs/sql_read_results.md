...
Cohort 2024A had the highest average pre-work score (81.8). This downward trend in subsequent cohorts (2024B and 2025A) might tell us that the entry requirements were stricter initially, or that the program has started accepting students with a wider variety of background skill levels.
...
Exactly 8 students scored 80 or above. It is interesting to see that while Jordanian students make up the majority of the top scorers, the high achievers are geographically diverse, including strong representations from Palestine and Egypt, showing talent is distributed across the region.
...
Looking at Hamza Tawfiq, he submitted his first project on time but his second project was marked as 'late' with a drop in his grade (from 72 to 65). This pattern tells us he might be struggling with time management or the increasing technical difficulty as the weeks progress.